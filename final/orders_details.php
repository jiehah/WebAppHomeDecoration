...
<head>
  ...
  <title>My Home Decoration System : Orders Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a164854, tbl_staffs_a164854_pt2,
          tbl_customers_a164854_pt2 WHERE
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      ?>
        <option value="<?php echo $productrow['fld_product_id']; ?>"><!--?php echo $productrow['fld_type']." ".$productrow['fld_product_name']; ?--></option>
      <?php
      }
      $conn = null;
      ?>
