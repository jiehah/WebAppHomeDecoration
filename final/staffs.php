...
<body>
  ...
  <div class="container-fluid">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="radio">
        <label>
        <input name="gender" type="radio" id="staffgender" value="Female" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_gender']=="Female") echo "checked"; ?> required> Female 
        </label>
      </div>
    </div>
  </div>
      <div class="form-group">
        <label for="staffphoneno" class="col-sm-3 control-label">Phone Number</label>
        <div class="col-sm-9">
      <input name="phone" type="text" class="form-control" id="staffphoneno" placeholder="Staff Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_phone_number']; ?>" required>
      </div>
  </div>
    <div class="form-group">
  ...
  <!--USERNAME -->
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="uname" type="text" class="form-control" id="uname" placeholder="Your Username" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_num']; ?>" required>
            </div>
          </div>
   ...
   <!--PASSWORD -->
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="upass" type="password" class="form-control" id="upass" placeholder="Your Password" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_password']; ?>" required>
            </div>
          </div>
          <!--re-PASSWORD -->
          <div class="form-group">
            <label for="reupass" class="col-sm-3 control-label">Re-enter Password</label>
            <div class="col-sm-9">
              <input name="reupass" type="password" class="form-control" id="reupass" placeholder="Re-Enter Your Password" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_password']; ?>" required>
            </div>
          </div>   
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a164854_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a164854_pt2");
            $stmt->execute();
            $result = $stmt->fetchAll();
