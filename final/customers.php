  ...
  <div class="container-fluid">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="radio">
      	<label>
      	<input name="gender" type="radio" id="customergender" value="Female" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Female") echo "checked"; ?> required> Female 
      	</label>
      </div>
  	</div>
	</div>
      <div class="form-group">
        <label for="customerphoneno" class="col-sm-3 control-label">Phone Number</label>
        <div class="col-sm-9">
      <input name="phone" type="text" class="form-control" id="customerphoneno" placeholder="Customer Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phone_number']; ?>" required>
  		</div>
	</div>
    <div class="form-group">
        <label for="customeraddress" class="col-sm-3 control-label">Address</label>
        <div class="col-sm-9">
      <input name="address" type="text" class="form-control" id="customeraddress" placeholder="Customer Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_address']; ?>" required> 
  		</div>
	</div>
	<div class="form-group">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a164854_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_customers_a164854_pt2");
            $stmt->execute();
            $result = $stmt->fetchAll();
