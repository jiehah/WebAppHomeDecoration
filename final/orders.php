  ...
  <div class="row">
    ...
    <form action="orders.php" method="post" class="form-horizontal">
     ...
     <div class="form-group">
       ...
       <div class="col-sm-9">
      <input class ="form-control" name="oid" type="text" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; ?>">
    </div>
    </div>
     ...
     <div class="form-group">
       ...
       <div class="col-sm-9">
      <input name="orderdate" class ="form-control"type="text" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>"> <br>
      </div>
      </div>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a164854, tbl_staffs_a164854_pt2, tbl_customers_a164854_pt2 WHERE ";
        $sql = $sql."tbl_orders_a164854.fld_staff_id = tbl_staffs_a164854_pt2.fld_staff_id and ";
        $sql = $sql."tbl_orders_a164854.fld_customer_id = tbl_customers_a164854_pt2.fld_customer_id";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a164854");
            $stmt->execute();
            $result = $stmt->fetchAll();
